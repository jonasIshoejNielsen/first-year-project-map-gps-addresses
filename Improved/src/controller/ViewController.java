...
public class ViewController implements Observer{
    ...
    public void goTo(OSMAddress address, String postcode) {
        canvasView.drawSelectedAddress(address, postcode);
        canvasView.goToPosition(address.getHousePlacement(postcode).getLon(), address.getHousePlacement(postcode).getLat());
        canvasView.repaint();
    }
    ...
    public void setRoute(OSMAddress from, String postcodeFrom, OSMAddress to, String postcodeTo) {
        lastCoords      = from.getHousePlacement(postcodeFrom).getCoordinate();
        currentCoords   = to.getHousePlacement(postcodeTo).getCoordinate();
    }
