...
public class Save {
    ...
    public boolean saveTGMFile(String fileName, CanvasModel canvasModel, KdTree kdTreeHouseNumbers, TernarySearchTries<OSMAddress> addresses, TernarySearchTries<PostcodeAndCityCenter> postcodes, TernarySearchTries<List<PostcodeAndCityCenter>> cities, List<AddedNote> addedNotes) {
        ...
        try {
            ...
            objectOutputStream.writeObject(postcodes);
